...
### for gen dataset
data_set_start_id = 703
data_set_length = 197
frames_range = range(0, 24)  # (0, 24) for dataset gen, smaller range for script testing
...
if gen_cali_images:
    ...
    print("generate calibating script end! now you can run: \
        'python stereo_calib.py temp/stereocali_render/' to calibrate \

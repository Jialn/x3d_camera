...
Test with real camera: "python struli_camera_main.py"
Record dataset command example: "python struli_camera_main.py dataset ./dataset_3dpattern 0"
...
#struli_lib_path = os.path.abspath(os.path.join('../struc_light'))
#sys.path.append(struli_lib_path)
...
# test with real camera: "python struli_camera_main.py"
# record dataset command example: "python struli_camera_main.py dataset ./dataset 0"
